...
- 1041bfa: Complete PostgreSQL grouping-set, ordered/hypothetical aggregate, window-frame, lateral function,
...
- 1041bfa: Infer PostgreSQL `UNION`, `INTERSECT`, and `EXCEPT` rows and recursive CTE seed/member contracts,
...
- 1041bfa: Add a public, versioned PostgreSQL extension manifest API for types, routines, operators, casts,
...
- 1041bfa: Complete PostgreSQL snapshot v2 introspection evidence for partition relationships, partition
...
- 1041bfa: Harden PostgreSQL execution with policy-owned scalar and array codecs, runtime extension codec OID
...
- 1041bfa: Publish the grammar-owned PostgreSQL support policy for upstream-supported majors 14 through 18,
...
- 1041bfa: Resolve PostgreSQL operators and snapshot v2 routines through a grammar-owned candidate selector
...
- 1041bfa: Add deterministic generated PostgreSQL core catalogs for every supported major and the canary.
...
- 1041bfa: Complete PostgreSQL DML parsing and analysis for identity overriding, `ON CONFLICT` targets and the
...
- 1041bfa: Cache PostgreSQL operator and capability resolution per schema snapshot so version-complete semantic analysis remains inside the compiler performance budget.
