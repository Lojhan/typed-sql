...
- fc2bf3f: Prevent child transactions from dispatching after their parent ends, reject overlapping sibling transaction work, and recheck queued work during database shutdown.
...
- 1041bfa: Add versioned and compile-option-aware SQLite JSON, JSONB, date/time, math, and optional-extension
...
- 1041bfa: Harden the optional Node SQLite adapter with connection-time SQLite version and compile-option
...
- 1041bfa: Complete SQLite schema-v2 evidence for rowid aliases, STRICT and `WITHOUT ROWID` tables, generated
  ...
  write analysis.
- 1041bfa: Graduate the SQLite grammar and optional `node:sqlite` adapter to the stable release track. The
...
- 1041bfa: Resolve SQLite core built-ins, operators, coercions, arities, nullability, and in-band function
