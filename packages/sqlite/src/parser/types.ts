...
export interface InExpression {
  readonly kind: "in";
  readonly expression: Expression;
  readonly values: readonly Expression[] | SelectStatement | FunctionTableReference | NamedTableReference;
...
export type TableReference = FunctionTableReference | NamedTableReference | SubqueryTableReference;
...
export interface WindowFrame {
  ...
  readonly exclude: "no-others" | "current-row" | "group" | "ties";
  readonly range: SourceRange;
}
...
export type ConflictAlgorithm = "rollback" | "abort" | "fail" | "ignore" | "replace";

export interface ConflictTargetTerm {
  readonly expression: Expression;
...
export interface UpsertClause {
  readonly target: readonly ConflictTargetTerm[];
...
export interface InsertStatement {
  ...
  readonly conflictAlgorithm?: ConflictAlgorithm;
  readonly columns: readonly Identifier[];
  readonly source: ValuesClause | DefaultValuesClause | SelectStatement;
  readonly upserts: readonly UpsertClause[];
