...
- 141ad85: Route SQL hover through grammar analysis and preserve upstream document synchronization when rapid edits supersede opening analysis. Keep queued source snapshots immutable.
