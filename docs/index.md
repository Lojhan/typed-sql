...
Edit the query and hover a binding, adapter result, or indexed row to inspect its inferred type. Switch grammars
above; the shared schema workspace supplies the evidence for every live example on the site.
